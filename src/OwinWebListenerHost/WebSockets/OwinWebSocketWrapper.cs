...
namespace OwinWebListenerHost.WebSockets
{
    using System;
    ...
    using WebSocketReceiveTuple = System.Tuple<int /* messageType */,
            bool /* endOfMessage */,
            int /* count */>;
    ...
    internal class OwinWebSocketWrapper
    {
        ...
        internal OwinWebSocketWrapper(WebSocket context, CancellationToken ct)
        {
            _context = context;

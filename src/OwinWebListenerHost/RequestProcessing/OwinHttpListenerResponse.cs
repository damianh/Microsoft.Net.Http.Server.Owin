...
namespace OwinWebListenerHost.RequestProcessing
{
    ...
    using OwinWebListenerHost.WebSockets;
    using Constants = OwinWebListenerHost.Constants;
    ...
    using WebSocketFunc = System.Func<System.Collections.Generic.IDictionary<string, object>, // WebSocket environment
    ...
    internal class OwinHttpListenerResponse
    {
        ...
        private static readonly Action<object> s_responseBodyStarted = OnResponseBodyStarted;
